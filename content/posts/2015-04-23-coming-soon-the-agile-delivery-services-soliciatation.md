...
Purchase
Agreement]({{ "/2015/01/08/creating-a-federal-marketplace-for-agile-delivery-services/" | url }}).
...
events]({{ "/2015/02/12/highlights-from-the-agile-delivery-services-industry-day-events/" | url }})
in February.
...
categories]({{ "/2015/03/10/Labor-Category-Descriptions-for-Agile-Procurements/" | url }}) specifically written for the types of agile staff that 18F needs. And, last, you’ll have to be quick &#8212; the required turnaround time to submit an RFQ response is (very) short.
