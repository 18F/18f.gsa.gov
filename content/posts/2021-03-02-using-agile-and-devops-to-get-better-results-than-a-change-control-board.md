...
{% image "assets/blog/image2.png" "Table labeled Thin Slice 'First Step' Features with three rows: first, next, and later. Each row has proposed functionality like submit a complaint and the functionality is color coded to indicate internal or external features." %}
...
If you are new to user stories, we have a blog post [describing the process for mapping user stories.]({{ "/2016/08/04/buying-better-digital-products-part-3-mapping-user-stories/" | url }}) 
...
* Agilefall: A common trap for teams new to agile is adding more meetings with agile-sounding names and sprint cadences while keeping waterfall development processes without the agile practices of regularly testing and iterating based on feedback. This is referred to as "agilefall" and typically leads to poor results and makes everyone less happy with the process and outcome. If this sounds familiar, you should read our blog post ["You might not be as agile as you think you are"]({{ "/2019/05/29/you-might-not-be-as-agile-as-you-think-you-are/" | url }}).
...
{% image "assets/blog/image3.png" "Launch prep testing guidance, including server, unit, and accessibility testing" %}
...
{% image "assets/blog/image1.png" "Launch prep automated testing and deployment pipeline, including: 1. Pull request review, 2. Release QA, and 3. Production release" %}
