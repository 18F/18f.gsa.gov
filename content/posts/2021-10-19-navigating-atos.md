...
{% image "assets/blog/navigating-atos/example-boundary-diagram.png" "Example boundary diagram with lines describing the types of connections between entities such as an API and routers" %}
