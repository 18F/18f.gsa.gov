...
Our [default LICENSE file](https://github.com/18F/open-source-policy/blob/master/LICENSE.md) for projects acknowledges that our work is in the US public domain, and uses [CC0](https://creativecommons.org/publicdomain/zero/1.0/) to waive copyright internationally.

Our [default CONTRIBUTING file](https://github.com/18F/open-source-policy/blob/master/CONTRIBUTING.md) informs contributors that their contributions will be licensed under the same terms.
