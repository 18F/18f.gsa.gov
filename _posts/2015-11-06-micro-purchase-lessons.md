...
![Traffic statistics for the CALC repository in GitHub](/assets/blog/micro-purchase/micro-purchase-analytics.jpg)
...
The Google Form itself had some weird quirks. The Google Apps Script we used, though tested, had some [unexpected behavior in production](https://code.google.com/p/google-apps-script-issues/issues/detail?id=4447) related to the Form Submit trigger. As a result, it was possible for people not to know [whether they were the leading bid](https://github.com/18F/calc/issues/255#issuecomment-151623562).

Then, there was obviously the $1 bid.
