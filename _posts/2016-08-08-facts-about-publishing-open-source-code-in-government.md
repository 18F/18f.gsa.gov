...
- The National Security Agency released code and documentation for its System Integrity Management Platform.
- The National Geospatial-Intelligence Agency releases open source projects and discusses them publicly, such as its GEOINT Pathfinder project.
- The US Army Research Laboratory has released public projects including the Dshell network forensic analysis framework.
