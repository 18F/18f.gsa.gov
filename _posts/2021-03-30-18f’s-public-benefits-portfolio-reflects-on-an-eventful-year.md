...
![A screenshot of the Alaska APD Home page. Showing the Summary budget by activity for FFY21]({{ site.baseurl }}{{ site.baseurl }}{{ site.baseurl }}/assets/blog/ak-apd-homepage.png "eAPD product (2021)")
