...
RSpec.describe Jekyll::TeamFilter do
  ...
  it "returns an image given a name that is an author and doesn't have an image" do
    embed_filter = Jekyll::TeamFilter
  ...
  it "returns an image given a name that is not an author and doesn't have an image" do
    embed_filter = Jekyll::TeamFilter
