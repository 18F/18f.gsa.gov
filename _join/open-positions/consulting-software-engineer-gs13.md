...
We're hiring a Consulting Software Engineer GS-13 to help us build amazing products for our clients. This page includes key objectives for the role as well as the official job description. [Duties]({{site.baseurl}}/join/consulting-software-engineer-gs13/#duties) and [Qualifications]({{site.baseurl}}/join/consulting-software-engineer-gs13/#qualifications) are specific to GS-13 level. You can apply at the bottom or learn more about the application process at [Joining 18F](https://18f.gsa.gov/join/#how-to-apply).
