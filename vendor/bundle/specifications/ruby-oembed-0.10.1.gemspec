# -*- encoding: utf-8 -*-
# stub: ruby-oembed 0.10.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--main".freeze, "README.rdoc".freeze, "--title".freeze, "ruby-oembed-0.10.1".freeze, "--inline-source".freeze, "--exclude".freeze, "tasks".freeze, "CHANGELOG.rdoc".freeze]
